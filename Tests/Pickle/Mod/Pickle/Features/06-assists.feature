...
#                                         call gives 0
#   Cow milk        14 per milking     -> bonus 28 on top of the 14 the pail always gives (16 sits between)
#
...
Feature: a companion at hand makes the work turn up more, through the real hooks
  ...
  # The one that reads the two protected members of the real game. The pail always gives 14 (the first run of
  # 2026-09-23 read that figure in the cow's def, not the 8 this comment first assumed): a gain of 16 or more can
  # only be the companion, which turns it into 42.
